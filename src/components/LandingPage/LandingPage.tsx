...
const LandingPage = () => {
  return (
    <div className="p-8 text-gray-800 bg-gray-100 h-full">
      ...
      <Link
        to={URL_PATH.desk}
        className="inline-block px-6 py-3 mt-6 bg-red-400 text-white rounded-full hover:bg-red-600 transition duration-300"
      >
